...
export const messages = {
  en: {
    ...
    subtitleFromListing: "Fill in the required fields.",
    ...
    listingsEmptyFiltered: "No apartments match these filters.",
    listingsFeaturedMissing: "That listing is no longer available.",
    listingsBedrooms: "Bedrooms",
    listingsBedroomsAny: "Any",
    listingsStudio: "Studio",
    listingsBedrooms3Plus: "3+",
    listingsSort: "Sort",
    listingsSortDefault: "Default",
    listingsSortRentAsc: "Price: low to high",
  ...
  fr: {
    ...
    subtitleFromListing: "Remplissez les champs requis.",
    ...
    listingsEmptyFiltered: "Aucun logement ne correspond à ces filtres.",
    listingsFeaturedMissing: "Cette annonce n’est plus disponible.",
    listingsBedrooms: "Chambres",
    listingsBedroomsAny: "Tous",
    listingsStudio: "Studio",
    listingsBedrooms3Plus: "3+",
    listingsSort: "Trier",
    listingsSortDefault: "Par défaut",
    listingsSortRentAsc: "Prix croissant",
